  ...
  <nav class="navbar navbar-inverse">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li><a href="http://127.0.0.1/projet/index.php/Visiteur/AfficherTousLesArticles#"> Voir tous les produits <span class="glyphicon glyphicon-th-list"></a></li>
          ...
          ?>
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> Voir par catégorie <span class="glyphicon glyphicon-file"> <b class="caret"> </b></a>
              ...
              if (!is_null($this->session->identifiant)) : 
                {
                  if ($this->session->statut =='admin')
                      {
                        echo '<li><a href="http://127.0.0.1/projet/index.php/Administrateur/AfficherCommandesNonTraitees">Voir les Commandes non validés <span class="glyphicon glyphicon-list-alt"></span></a></li>';
                      }
                }
              endif;
            ?>
